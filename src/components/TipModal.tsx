            ...
            <div className="space-y-6">
                 ...
                 <form onSubmit={handleCustomSubmit} className="flex gap-2">
                   <div className="relative flex-1">
                     ...
                     <input 
                       ...
                       className="w-full pl-7 pr-4 py-2.5 bg-gray-50 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-500"
             ...
             <div className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                   ...
                   {balance !== null && balance < Math.round(parseFloat(amount) * 100) && (
                      <div className="text-red-500 text-xs font-semibold mt-2 flex items-center gap-1">
                         ...
                         <Link href="/wallet" className="underline hover:text-red-600">Recharge now</Link>
                      </div>
                   )}
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 bg-yellow-400 hover:bg-yellow-500 text-black rounded-xl font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
